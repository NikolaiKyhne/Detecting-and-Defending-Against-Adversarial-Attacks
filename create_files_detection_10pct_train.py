...
class Experiment():
    ...
    def run(self):
        ...
        clean_fs = sorted(clean_fs, key=extract_number)[0:30]

        attacked_fs = sorted(attacked_fs, key=extract_number)[0:30]
        ...
        df.to_csv(r'C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\adv_detection\5step\Long\output.csv', index=False)
exp = Experiment()
