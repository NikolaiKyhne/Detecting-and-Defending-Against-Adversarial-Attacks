...
parser.add_argument('--t', type=int, default=5, help='diffusion steps, control the sampling noise scale')
...
def example():
    ...
    audio_file = r'C:/Users/kyhne/OneDrive - Aalborg Universitet/Uni/7. semester/P7 - Informationsbehandling i teknologiske systemer/AudioPure-master/Additional Results/100 1000/n=0.wav'
    ...
    output_file_path = r'C:/Users/kyhne/OneDrive - Aalborg Universitet/Uni/7. semester/P7 - Informationsbehandling i teknologiske systemer/AudioPure-master/Additional Results/100 1000/n=5.wav'
...
class Experiment():
    ...
    def run(self):
        ...
        words.remove(to_pop)
        for word in words:
            folder = r"C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\Output" + "\\" + to_pop + "\\" + word
