...
def example():
    ...
    audio_file = r'C:/Users/kyhne/Downloads/WB_filer/down_go.wav'
...
class Experiment():
    ...
    def run(self):
        ...
        words.remove(to_pop)
        for word in words:
            folder = r"C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\output_10_500_20\result" + "//" + to_pop + "//" + word
