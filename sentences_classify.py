...
class Experiment():
    ...
    def run(self):
        ...
        # folder =  r"C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\Output_Common_10_5000_medium"
        ...
        for i in fs:
            ...
            # elif transcription == "open all doors":
            elif transcription == "switch off internet connection":
            # elif transcription == "i need a reservation for sixteen people at the seafood restaurant down the street":
