...
class Experiment():
    ...
    def run(self):
        ...
        df.to_csv(r'C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\ROC\long2.csv', index=False)
exp = Experiment()
