...
def create_diffwave_model(model_path, config_path, reverse_timestep):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default=r'C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\diffusion_models\DiffWave_Unconditional\config.json', 
    ...
    model_path = r'C:\Users\kyhne\OneDrive - Aalborg Universitet\Uni\7. semester\P7 - Informationsbehandling i teknologiske systemer\AudioPure-master\1000000.pkl'
    checkpoint = torch.load(model_path)
    Net.load_state_dict(checkpoint['model_state_dict'])

    Denoiser = DiffWave(model=Net, diffusion_hyperparams=diffusion_hyperparams, reverse_timestep=5)
